...
class CinderManager(object):
    ...
    def volume_create(self, context, name, size, description, v_type,
        ...
        return self.v_manager.create(name=name,
                                     size=size,
                                     is_start=is_start,
    ...
    def snap_create(self, name, description, metadata, volume_uuid):
        return self.snap_manager.create(name=name, description=description,
                                        metadata=metadata,
                                        volume_uuid=volume_uuid)

    def snap_list(self):
        return self.snap_manager.list()
...
class CinderRouteManager(object):
    ...
    def snap_delete(self, snapshot_uuid):
        return self.snap_manager.delete(snapshot_uuid)

    def snap_update(self):
        return self.snap_manager.update()

    def snap_detail(self, snapshot_uuid):
